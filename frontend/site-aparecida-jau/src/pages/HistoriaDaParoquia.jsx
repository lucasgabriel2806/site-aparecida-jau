  ...
  return (
    ...
    <div className='flex justify-center px-[20px]'>
      ...
      <div className='w-full max-w-[1000px] pt-[50px]'>
        ...
        <p className="text-[18px] md:text-[20px] text-[#555] mt-[15px]">
          Vamos contar a história do nosso começo e de como a comunidade teve um papel fundamental na construção de nossa história.
        </p>

        <p className="text-[13px] md:text-[14px] text-[#888] mt-[10px]">
          Por <span className="font-semibold">Douglas Mendes Soto e Letícia Maria</span>
        </p>

        <img
          className='rounded-[15px] mt-[50px] w-full object-cover'
          src={capa_noticia}
          alt="Igreja antiga"
        />

        <div className='flex flex-col gap-[50px] w-full max-w-[700px] mt-[50px] text-[16px] md:text-[18px] text-justify leading-[1.8] [&_img]:rounded-[15px] [&_img]:w-full'>

          <div className='flex flex-col gap-[15px]'>

            <Heading className='text-[#034389] font-bold' size='18px' level={2}>
          ...
          <img
            loading="lazy"
            src={img_noticia1}
            alt="Foto antiga da comunidade da Paróquia Nossa Senhora Aparecida"
          />
          ...
          <img
            loading="lazy"
            src={img_noticia2}
            alt="Registro histórico dos primeiros passos para a elaboração da construção"
          />
          ...
          <img
            loading="lazy"
            src={img_noticia3}
            alt="Subcomissão de mulheres presidida por Ana Rosa de Paula"
          />
          ...
          <img
            loading="lazy"
            src={img_noticia4}
            alt="As primeiras pregações feitas no quinto dia de cada mês"
          />
          ...
          <img
            loading="lazy"
            src={img_noticia5}
            alt="A apresentação da pedra fundamental"
          />
          ...
          <img
            loading="lazy"
            src={img_noticia6}
            alt="O processo da construção da igreja"
          />
          ...
          <img
            loading="lazy"
            src={img_noticia7}
            alt="Vitral que faz referência a igreja antiga presente na paróquia até os dias de hoje"
          />
